...
| Name           | Role        |
| :------------- | :---------- |
| Tran Quang Đông | Team Leader |
| Vũ Thị Bích Diệp  | Member      |
| Nguyễn Văn B   | Member      |
...
<details>
  <summary>Week 12 Report, from date 27/11/2023 ~ to 3/12/2023</summary>
<br>
<details>
...
- Assigned tasks:
  - Topic: Find coupling in package Entity, and 1/2 class in package Controllers
